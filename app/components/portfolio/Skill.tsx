  ...
  return (
    <>
      ...
      <AnimatedItem animation="fadeInDown" elementType="div" className="flex flex-wrap">
        ...
        <div className="ml-2 mb-2 w-[450px] border border-gray-700">
        ...
        <div className="mr-2 mt-2 w-[450px] border border-gray-700">
        ...
        <div className="ml-2 mt-2 w-[450px] border border-gray-700">
