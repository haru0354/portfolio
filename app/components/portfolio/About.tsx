      ...
      <div className="max-w-[1050px] mx-auto py-4 mt-10">
        ...
        >
          <div className="w-full sm:flex-1 order-2 sm:order-1">
            ...
            <p>高校3年生の時に「ホームページビルダー」や「無料ブログ
            サービス」を利用しつつ、約1年間の間、htmlとcssを少し勉強しながら収益を得ていました。その後、関係ない職種に就職。</p>
            <p>28歳の時に「wordPress」などを利用しwebメディアを作成し、web広告業として個人事業主として開業をし、生計を立てて今に至ります。
            36歳の時にエンジニアの職種に就きたいと決意し、勉強を開始しています。</p>
            <ul className="my-4">
              <li>GitHub: <a href="https://github.com/haru0354" target="blank" className="text-blue-500">https://github.com/haru0354</a></li>
              <li></li>
            </ul>
          </div>
